...
Pigdoku adds three passing browser scenarios for the full three-character cycle, direct selection, persistent moves/history, 320 × 568 board and character-picker fit, pig tutorial/error/win art, sharing and offline decoding of six pig sounds. The existing character-switch regression, full desktop/phone smoke suite and offline-release audit were rerun and passed. The gallery now exports six GIFs and eighteen sounds across the three characters.
