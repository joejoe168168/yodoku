...
const CACHE = 'yodoku-v7';
const SHELL = ['./', './index.html', './app.js', './engine.js', './manifest.json', './icons/icon.svg', './icons/icon-192.png', './icons/icon-512.png', './icons/apple-touch-icon.png', './assets/ko-icon.svg', './assets/pig-icon.svg', ...['yo','ko','pig'].flatMap(character => ['x','clear','place','error','hint','win'].map(event => `./assets/sounds/${character}-${event}.wav`))];
